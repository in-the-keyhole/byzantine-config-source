            ...
            <form className="form-horizontal">
                <fieldset>
                    ...
                    <div className="control-group">
                        ...
                        <div className="controls">
                            <button id="pickdir" onClick={this.dirClick} name="doublebutton-0" className="btn btn-info">Select Directory</button>   <input id="creds" size="80" readonly="true" name="textinput-1" type="text" onChange={this.handleChange} value={this.state.creds} className="input-xlarge" />
